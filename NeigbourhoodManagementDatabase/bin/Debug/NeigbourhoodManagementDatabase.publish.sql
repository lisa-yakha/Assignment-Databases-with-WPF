...
values
(NEWID(), @NameOfAuhor,@BuildingNumberOfAuthor,@ApartmentNumberOfAuthor, @Description, @BuildingNumberOfComplaint, @ApartmentNumberOfComplaint, @ComplaintCategory, 0 , SYSUTCDATETIME())
GO
PRINT N'Creating Procedure [dbo].[RETRIEVE_ComplaintsByDate]...';
...
CREATE PROCEDURE [dbo].[RETRIEVE_ComplaintsByDate]
	@Keyword DATE
AS
SELECT Id,NameOfAuhor,BuildingNumberOfAuthor,ApartmentNumberOfAuthor, Description, BuildingNumberOfComplaint, ApartmentNumberOfComplaint, ComplaintCategory, ComplaintStatus, DateAdded FROM Complaints WHERE CAST(DateAdded AS DATE) = @Keyword
GO
PRINT N'Creating Procedure [dbo].[RETRIEVE_ComplaintsByNameOfAuthor]...';
...
GO
PRINT N'Creating Procedure [dbo].[UPDATE_ComplaintStatus]...';
